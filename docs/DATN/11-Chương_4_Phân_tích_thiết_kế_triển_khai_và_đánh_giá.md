...
- **[Hình 4.8]**: _Sơ đồ khối kiến trúc Event-Driven của hệ thống tương tác ASL VR._
...
- **[Hình 4.9]**: _Sơ đồ gói (Package Diagram) phân rã 3 lớp của ứng dụng._
...
- **[Hình 4.10]**: _Sơ đồ lớp (Class Diagram) chi tiết của toàn bộ hệ thống lớp ASL VR._
...
- **[Hình 4.11]**: _Ảnh chụp màn hình NPC Kyle hướng dẫn thực hành cử chỉ trực quan._
- **[Hình 4.12]**: _Ảnh chụp màn hình phản hồi màu sắc cử chỉ tĩnh._
- **[Hình 4.13]**: _Ảnh chụp màn hình vẽ nét quỹ đạo trong không gian thực tế ảo._
- **[Hình 4.14]**: _Ảnh chụp màn hình bảng điều khiển đeo tay cập nhật tiến trình thực tế._
