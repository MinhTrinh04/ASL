...
| **Thiết kế UI/UX chống xao nhãng thị giác** | Không áp dụng                                 | UI Canvas phẳng lơ lửng gây cản trở tương tác tay     | Menu lật cổ tay ẩn (**Wrist Dashboard**) và Billboard hướng mặt    |
...
Định hướng sử dụng trò chơi như một phòng thực nghiệm ảo tương tác bổ trợ được xây dựng dựa trên các cơ sở khoa học sư phạm vững chắc và các yêu cầu kỹ thuật phi chức năng chặt chẽ:

1.  **Cơ sở khoa học sư phạm (EdTech foundations)**: 
    *   *Nón trải nghiệm Edgar Dale*: Thúc đẩy việc "học qua hành động trực tiếp" (Learning by Doing) thông qua đôi bàn tay trần vật lý, giúp kích hoạt trí nhớ vận động cơ bắp (muscle memory) sâu rộng, gia tăng tỉ lệ ghi nhớ kiến thức dài hạn lên tới 90%.
    *   *Thuyết học tập trải nghiệm của David Kolb*: Thiết lập chu trình phản hồi sinh học 4 bước khép kín (Quan sát Kyle làm mẫu $\rightarrow$ Nhận phản hồi đổi màu UI ngay lập tức qua Wrist Dashboard hoặc UIFaceCamera $\rightarrow$ So sánh và tự khái quát hóa góc khớp ngón tay $\rightarrow$ Chủ động thực nghiệm động tác mới) giúp học sinh tự sửa sai liên tục và làm chủ ngôn ngữ ký hiệu một cách tự nhiên.
2.  **Cơ sở yêu cầu kỹ thuật phi chức năng (Non-functional technical bases)**:
    *   *Hiệu suất khung hình cao (FPS)*: Hệ thống bắt buộc phải duy trì mức hiệu suất ổn định từ 72 đến 90 FPS trực tiếp trên kính standalone Meta Quest. Việc sụt giảm khung hình sẽ phá vỡ vòng phản hồi sinh học và gây ra hiện tượng say VR (VR sickness) nghiêm trọng cho người học.
    *   *Độ trễ phản hồi cực thấp (Latency)*: Độ trễ từ lúc người học thay đổi cử chỉ ngón tay vật lý cho đến khi hệ thống nhận diện và cập nhật hiển thị màu sắc trên màn hình kính bắt buộc phải nhỏ hơn 0.2 giây. Điều này đảm bảo tính tương tác thời gian thực tức thì, tạo cảm giác mượt mà và tự nhiên nhất cho chuyển động của các ngón tay.
    *   *Độ chính xác cao (Accuracy)*: Hệ thống nhận dạng cử chỉ phải đạt tỉ lệ chính xác tối thiểu 85% đối với các cử chỉ tĩnh và nét vẽ động phức tạp, tránh việc đánh giá sai lệch gây ức chế tâm lý cho người học trong suốt quá trình làm bài thực hành và kiểm tra.
