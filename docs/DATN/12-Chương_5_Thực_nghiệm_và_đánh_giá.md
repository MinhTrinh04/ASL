...
| Nhóm đối chứng      | Điểm trung bình ($M$) | Độ lệch chuẩn ($SD$) |
| :------------------ | :-------------------: | :------------------: |
...
| Nhóm đối chứng      | Điểm trung bình sau 1 tuần ($M$) | Khả năng lưu giữ (%) |
| :------------------ | :------------------------------: | :------------------: |
